...
public class input {
	...
	private static final String INT_ERROR = "El valor introducido no es un numero";
	...
	public static void toContinue() {
		...
		try {
			//ESTO SI NO SE CAMBIA DA ERRORES
			keyboard.nextLine();
		} catch (Exception e) {
			System.out.print("Ha ocurrido un error al continuar...");
		}
	}
}